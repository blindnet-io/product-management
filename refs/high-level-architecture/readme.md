...
- [blindnet devkit](../lexicon/RFC-Lexicon-2.md#blindnet-devkit) to be interoperable with 3rd party solutions (that cover a sub-scope of our scope or that cover requirements adjacent to our scope),
