...
A Data Capture can be captured at once or over the course of multiple interactions. One or more Submitters can complete a Data Capture.
...
**Data Subjects** are users concerned by the data being caputred in a particular Data Capture.
